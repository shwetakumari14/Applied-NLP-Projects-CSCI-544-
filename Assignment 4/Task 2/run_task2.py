...
with open('./vocab_dictionary1.pickle', 'rb') as fr1:
    Word_to_Index = pickle.load(fr1)
with open('./ner_dictionary1.pickle', 'rb') as fr2:
    Index_to_Word = pickle.load(fr2)
with open('./int_vocab_dictionary1.pickle', 'rb') as fr3:
    NER_to_Index = pickle.load(fr3)
with open('./int_ner_dictionary1.pickle', 'rb') as fr4:
    Index_to_Ner = pickle.load(fr4)
with open('./loader_train1.pickle', 'rb') as fr5:
    loader_train = pickle.load(fr5)
with open('./loader_dev1.pickle', 'rb') as fr6:
    loader_dev = pickle.load(fr6)
with open('./loader_test1.pickle', 'rb') as fr7:
    loader_test = pickle.load(fr7)
with open('./embedding_matrix.pickle', 'rb') as fr8:
    embedding_matrix = pickle.load(fr8)
...
def evaluateModelTest(model, dataloader, predict_table):
    model.eval()
